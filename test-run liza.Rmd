...
data(WHONET) # world health org dat
?WHONET
head(WHONET,4)
```
...
idealkidera 
table(idealkidera$sublocation) #  there are 24 entries of kidera sub locATION
```
...
```{r}
ideal2<- ideal1%>% # This is piping
  mutate(ReasonsLoss=recode(ReasonsLoss,"6"="ownerdeclined", "7"="Death", "12"="Relocation", "18"="Given out"))%>%
  mutate()
```
